...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.index')->with('success', MsgApp::SUCCESS_ADDED);
    }
    ...
    public function show($id)
    {
        ...
        return redirect()->route('admin.roles.index')->with('success', MsgApp::SUCCESS_DEL);
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        $role->syncPermissions($request->permissions);
        return redirect()->route('admin.roles.index')->with('success', MsgApp::SUCCESS_UPD);
    }
