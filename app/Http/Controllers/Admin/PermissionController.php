...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', MsgApp::SUCCESS_ADDED);
    ...
    public function show($id)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', MsgApp::SUCCESS_DEL);
    }
    ...
    public function update(Request $request, Permission $permission)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', MsgApp::SUCCESS_UPD);
