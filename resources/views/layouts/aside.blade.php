            ...
            <ul class="menu-nav ">
                ...
                <li class="menu-item  {{ (request()->is('admin/roles*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('admin.roles.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon">
                            <en class="la la-arrow-circle-right"></en>
                        </span><span class="menu-text">Role</span>
                    </a>
                </li>
                @endcan
                @canany('Permission access','Permission create','Permission edit','Permission delete')
                
                <li class="menu-item  {{ (request()->is('admin/permissions*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('admin.permissions.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon">
                            <en class="la la-arrow-circle-right"></en>
                        </span><span class="menu-text">Permission</span>
                    </a>
                </li>
                @endcanany
                ...
                <li class="menu-item {{ (request()->is('admin/logout*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
